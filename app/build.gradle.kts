...
dependencies {
    ...
    implementation("com.mapbox.navigationux:cluster:1.0.0-beta.44")
    implementation("com.mapbox.navigationux:weather-api:1.0.0-beta.44")
    implementation("com.mapbox.navigationux:data-inputs:1.0.0-beta.44")
