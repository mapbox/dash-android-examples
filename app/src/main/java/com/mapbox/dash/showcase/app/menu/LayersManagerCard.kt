...
import com.mapbox.dash.showcase.app.databinding.LayersManagerBinding
import com.mapbox.dash.showcase.app.repeatWhenStarted
...
class LayersManagerCard @JvmOverloads constructor(
    ...
    private val binding: LayersManagerBinding = LayersManagerBinding.inflate(
