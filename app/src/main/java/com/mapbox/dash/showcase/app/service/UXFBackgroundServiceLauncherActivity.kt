...
import com.mapbox.dash.showcase.app.service.UXFBackgroundService.Companion.FOREGROUND_NOTIFICATION_CHANNEL_ID
...
internal class UXFBackgroundServiceLauncherActivity : AppCompatActivity() {
        ...
        when {
            ...
            !areNotificationsEnabled() -> {
                AlertDialog.Builder(this)
                    .setIcon(com.mapbox.navigation.ui.maps.R.drawable.mapbox_navigation_puck_icon)
    ...
    private fun isNotificationChannelEnabled(): Boolean {
        ...
        val channel = notificationManager.getNotificationChannelCompat(FOREGROUND_NOTIFICATION_CHANNEL_ID)
